  ...
  <nav class="navbar navbar-red navbar-fixed-top">
    <div class="container">
      ...
      <ul class="nav navbar-nav">
        <li class="active"><a href="<?php echo base_url('index.php/welcome/doctorpage') ?>">Notification</a></li>
        <li><a href="<?php echo base_url('index.php/welcome/pharmacydoctor') ?>">Pharmacy</a></li>
        </li>
      </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right text-center">
        <li class="dropdown pull-right">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">Dr. Monte Costa,phd</a></li>
